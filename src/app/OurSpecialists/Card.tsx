...
const Card: FC<CardInterface> = ({ image, name, details }) => {
  return (
    <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 p-6 sm:p-8 lg:p-10 rounded-2xl overflow-hidden shadow-lg cursor-pointer bg-eagle-green-950 w-full max-w-[1126px] mx-auto">
